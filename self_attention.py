...
class SelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        energy = torch.matmul(Q, K.transpose(-2, -1))  # (batch_size, seq_length, seq_length)
...
if __name__ == "__main__":
    ...
    print(f"Self Attention Output Shape: {out.shape}")  # (batch_size=2, seq_length=3, d_model=5)
